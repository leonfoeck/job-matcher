            ...
            <Page size="A4" style={styles.page}>
                ...
                <View>
                    ...
                    <Text style={styles.headline}>
                        {profile.headline || ''}{target.company || target.jobTitle ? ` • Target: ${[target.jobTitle, target.company].filter(Boolean).join(' @ ')}` : ''}
                    </Text>
                </View>
                        ...
                        {chosenExperiences.map((x, i) => (
                            <View key={i} style={{ marginBottom: 6 }}>
                                <View style={styles.row}>
                                    ...
                                    <Text className="small">{[x.start, x.end || 'Present'].filter(Boolean).join(' — ')}</Text>
                                </View>
